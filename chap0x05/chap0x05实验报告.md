...
* 切换到Java的安装目录下，执行bin\jlink.exe --module-path jmods --add-modules java.desktop --output jre 生成jre文件；
...
* 创建项目后，打开File->settings,搜索Gradle进行配置，可选内置 gradle 或自己安装的 gradle。

  * 选择内置gradle![](images/gradle.png)
